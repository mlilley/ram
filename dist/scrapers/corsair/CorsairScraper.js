...
const CorsairPartDetail_1 = require("./CorsairPartDetail");
const CorsairSearchResult_1 = require("./CorsairSearchResult");
class CorsairScraper extends BaseScraper_1.default {
    scrapePartDetail(partNo) {
     ...
     */
    findExactSearchResult(partNo, searchResults) {
    ...
    extractSearchResults(html) {
        ...
        $("div.ProductGridView > div.ProductGridView ul.List li").each((i, domEl) => {
            const el = $(domEl);
            const item = new CorsairSearchResult_1.default();
    ...
    partUrlToCode(partUrl) {
        const pathname = url.parse(partUrl).pathname;
        const i = pathname.lastIndexOf("/");
        return pathname.substr(i);
    }
}
exports.default = CorsairScraper;
//# sourceMappingURL=CorsairScraper.js.map